...
# python project_umap_3d.py "results\clusters\baseline\clusters_dim5_silhouette_k2.npy"
...
# python project_umap_3d.py "results\clusters\autoencoder\clusters_dim16_silhouette_k2.npy"
